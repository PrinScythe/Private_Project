...
public class OutilsBille {
	...
	private static Vector<Bille> autresBilles(Bille cetteBille, Vector<Bille> billes) {
		Vector<Bille> autresBilles = new Vector<>();
	 ...
	 *
	 *            gestion de l'�ventuelle collision de cette bille avec les autres
	 *            billes
	 *
	 ...
	 *         intactes
	 */
	static boolean gestionCollisionBilleBille(Bille cetteBille, Vector<Bille> billes) {
	...
	public static Vecteur gestionAccelerationNewton(Bille cetteBille, Vector<Bille> billes) {
		...
		// -------------- � pr�sent on r�cup�re les masses et les positions des autres
		// billes ------------------
		int i;
		Bille billeCourante;
		...
		// ------------------ � pr�sent on calcule le champ de gravit� exerc� par les
		// autres billes sur cette bille ------------------
